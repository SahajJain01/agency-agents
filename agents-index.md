...
220 agents across 17 divisions. Each entry lists the agent's
...
- 🗺️ **Geographer** — `academic/academic-geographer.md`
...
- 🎭 **Persona Walkthrough Specialist** — `design/design-persona-walkthrough.md`
...
- 🏗️ **Backend Architect** — `engineering/engineering-backend-architect.md`
...
- 👁️ **Code Reviewer** — `engineering/engineering-code-reviewer.md`
...
- 🗄️ **Database Optimizer** — `engineering/engineering-database-optimizer.md`
...
- ⚙️ **DevOps Automator** — `engineering/engineering-devops-automator.md`
  Expert DevOps engineer specializing in infrastructure automation, CI/CD pipeline development, and cloud operations
- 🛒 **Drupal Shopping Cart Engineer** — `engineering/engineering-drupal-shopping-cart.md`
...
- 🖥️ **Frontend Developer** — `engineering/engineering-frontend-developer.md`
...
- 🖧 **IT Service Manager** — `engineering/engineering-it-service-manager.md`
...
- 🕸️ **Multi-Agent Systems Architect** — `engineering/engineering-multi-agent-systems-architect.md`
...
- 📜 **OrgScript Engineer** — `engineering/engineering-orgscript-engineer.md`
...
- 🏛️ **Software Architect** — `engineering/engineering-software-architect.md`
...
- ⛓️ **Solidity Smart Contract Engineer** — `engineering/engineering-solidity-smart-contract-engineer.md`
...
- 🛡️ **SRE (Site Reliability Engineer)** — `engineering/engineering-sre.md`
...
- 🎙️ **Voice AI Integration Engineer** — `engineering/engineering-voice-ai-integration-engineer.md`
...
- 🛍️ **WordPress Shopping Cart Engineer** — `engineering/engineering-wordpress-shopping-cart.md`
...
- 🗺️ **Level Designer** — `game-development/level-designer.md`
...
- 🏔️ **3D & Scene Developer** — `gis/gis-3d-scene-developer.md`
...
- 🖥️ **GIS Analyst** — `gis/gis-analyst.md`
...
- 🏗️ **BIM/GIS Specialist** — `gis/gis-bim-specialist.md`
...
- 🎨 **Cartography Designer** — `gis/gis-cartography-designer.md`
...
- 🛸 **Drone/Reality Mapping Specialist** — `gis/gis-drone-reality-mapping.md`
...
- ⚙️ **Geoprocessing Specialist** — `gis/gis-geoprocessing-specialist.md`
  ArcPy and Python toolbox expert who automates spatial workflows — builds .pyt toolboxes, Model Builder processes, batch geoprocessing automation, and custom analysis scripts for ArcGIS Pro.
- ✅ **GIS QA Engineer** — `gis/gis-qa-engineer.md`
...
- 🔧 **Solution Engineer** — `gis/gis-solution-engineer.md`
...
- 📦 **Spatial Data Engineer** — `gis/gis-spatial-data-engineer.md`
...
- 📊 **Spatial Data Scientist** — `gis/gis-spatial-data-scientist.md`
...
- 🧠 **Technical Consultant** — `gis/gis-technical-consultant.md`
...
- 🌐 **Web GIS Developer** — `gis/gis-web-gis-developer.md`
...
- 🏗️ **AEO Foundations Architect** — `marketing/marketing-aeo-foundations.md`
...
- ✍️ **Content Creator** — `marketing/marketing-content-creator.md`
...
- 🎙️ **Livestream Commerce Coach** — `marketing/marketing-livestream-commerce-coach.md`
...
- 📡 **Multi-Platform Publisher** — `marketing/marketing-multi-platform-publisher.md`
...
- 🛰️ **X/Twitter Intelligence Analyst** — `marketing/marketing-x-twitter-intelligence-analyst.md`
...
- ✍️ **Ad Creative Strategist** — `paid-media/paid-media-creative-strategist.md`
...
- 🏋️ **Sales Coach** — `sales/sales-coach.md`
...
- 🛠️ **Sales Engineer** — `sales/sales-engineer.md`
...
- 🔐 **Application Security Engineer** — `security/security-appsec-engineer.md`
...
- 🛡️ **Security Architect** — `security/security-architect.md`
...
- ☁️ **Cloud Security Architect** — `security/security-cloud-security-architect.md`
...
- 📋 **Compliance Auditor** — `security/security-compliance-auditor.md`
...
- 🚨 **Incident Responder** — `security/security-incident-responder.md`
...
- 🗡️ **Penetration Tester** — `security/security-penetration-tester.md`
...
- 🛡️ **Senior SecOps Engineer** — `security/security-senior-secops.md`
...
- 🎯 **Threat Detection Engineer** — `security/security-threat-detection-engineer.md`
...
- 🔍 **Threat Intelligence Analyst** — `security/security-threat-intelligence-analyst.md`
...
- 🖥️ **Terminal Integration Specialist** — `spatial-computing/terminal-integration-specialist.md`
...
- 🕹️ **XR Cockpit Interaction Specialist** — `spatial-computing/xr-cockpit-interaction-specialist.md`
...
- 🎛️ **Agents Orchestrator** — `specialized/agents-orchestrator.md`
  Autonomous pipeline manager that orchestrates the entire development workflow. You are the leader of this process.
- ⚙️ **Automation Governance Architect** — `specialized/automation-governance-architect.md`
...
- 🔄 **Change Management Consultant** — `specialized/change-management-consultant.md`
...
- 💼 **Chief Financial Officer** — `specialized/chief-financial-officer.md`
...
- 🎧 **Customer Service** — `specialized/customer-service.md`
...
- 🗄️ **Data Consolidation Agent** — `specialized/data-consolidation-agent.md`
  AI agent that consolidates extracted sales data into live reporting dashboards with territory, rep, and pipeline summaries
- 🔐 **Data Privacy Officer** — `specialized/data-privacy-officer.md`
...
- 🌱 **ESG & Sustainability Officer** — `specialized/esg-sustainability-officer.md`
...
- 🏛️ **Government Digital Presales Consultant** — `specialized/government-digital-presales-consultant.md`
...
- 📝 **Grant Writer** — `specialized/grant-writer.md`
...
- 🏥 **Healthcare Customer Service** — `specialized/healthcare-customer-service.md`
...
- ⚕️ **Healthcare Marketing Compliance Specialist** — `specialized/healthcare-marketing-compliance.md`
...
- 🏨 **Hospitality Guest Services** — `specialized/hospitality-guest-services.md`
...
- 🤝 **HR Onboarding** — `specialized/hr-onboarding.md`
...
- 🕸️ **Identity Graph Operator** — `specialized/identity-graph-operator.md`
...
- 🌐 **Language Translator** — `specialized/language-translator.md`
...
- ⏱️ **Legal Billing & Time Tracking** — `specialized/legal-billing-time-tracking.md`
...
- 📋 **Legal Client Intake** — `specialized/legal-client-intake.md`
...
- ⚖️ **Legal Document Review** — `specialized/legal-document-review.md`
...
- 🏦 **Loan Officer Assistant** — `specialized/loan-officer-assistant.md`
...
- 🤝 **M&A Integration Manager** — `specialized/ma-integration-manager.md`
...
- 🏥 **Medical Billing & Coding Specialist** — `specialized/medical-billing-coding-specialist.md`
...
- ⚙️ **Operations Manager** — `specialized/operations-manager.md`
...
- 🧠 **Organizational Psychologist** — `specialized/organizational-psychologist.md`
...
- 🌱 **Personal Growth Mentor** — `specialized/personal-growth-mentor.md`
...
- 🏠 **Real Estate Buyer & Seller** — `specialized/real-estate-buyer-seller.md`
...
- 🛒 **Retail Customer Returns** — `specialized/retail-customer-returns.md`
...
- 🎯 **Sales Outreach** — `specialized/sales-outreach.md`
...
- 🏗️ **Civil Engineer** — `specialized/specialized-civil-engineer.md`
...
- 🗣️ **Developer Advocate** — `specialized/specialized-developer-advocate.md`
...
- ☁️ **Salesforce Architect** — `specialized/specialized-salesforce-architect.md`
...
- ⚔️ **Strategy Duel Agent** — `specialized/specialized-strategy-duel-agent.md`
  Conducts live strategy duels using game theory and the 36 Chinese stratagems
- 🗺️ **Workflow Architect** — `specialized/specialized-workflow-architect.md`
...
- 🗃️ **ZK Steward** — `specialized/zk-steward.md`
...
- ⚖️ **Legal Compliance Checker** — `support/support-legal-compliance-checker.md`
...
- ⏱️ **Performance Benchmarker** — `testing/testing-performance-benchmarker.md`
